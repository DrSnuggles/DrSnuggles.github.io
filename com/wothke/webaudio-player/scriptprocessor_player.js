/**
DrSnuggles added: loadURLfromData
*/
/**
...
// ******* (music) file input related
		...
		*/
		...
		/**
		* Loads from Data.
		* added by DrSnuggles for js unzipped data of type arraybuffer
		*/
		loadMusicFromData: function(url, data, options, onCompletion, onFail, onProgress) {
			this.initByUserGesture();	// cannot be done from the callbacks below.. see iOS shit
			...
			this.trace("loadMusicFromData successfully loaded: "+ fullFilename);
